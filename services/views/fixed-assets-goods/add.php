<div class="site-login">
    <div class="show-img-box">
        ...
        echo $form->field($model,'category_id')->dropDownList(\services\models\FixedAssetsGoods::getCategory());
        ...
        echo $form->field($model,'is_sale',['inline'=>1])->radioList(\services\models\FixedAssetsGoods::$is_on_sale);
