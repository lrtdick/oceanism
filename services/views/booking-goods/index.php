...
<?php //if(1==2):?>
<?php if(!\services\models\BookingRecord::findOne($order_id)->checkin_time && \services\models\BookingRecord::findOne($order_id)->status==1):?>
<?=\yii\bootstrap\Html::a('预定商品',['booking-goods/add','order_id'=>$order_id],['class'=>'btn btn-sm btn-success pull-left'])?>
<?php endif;?>
<!--    --><?php //endif;?>
