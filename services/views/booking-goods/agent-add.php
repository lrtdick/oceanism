<div class="site-login">
    <h3 style="color:cornflowerblue">商品预定</h3>
        ...
        <form action="" method="post" class="box-form">
            <div class="box" style="width: 100%;height:200px;">
                ...
                <?php foreach (\services\models\BookingGoods::getGoods() as $k => $v) { ?>
                    <div class="box-box">
                        <input type="checkbox" name="id[]" data-k="<?= $k ?>" class="box-input"
                               value="<?= $v->id ?>"><?= $v->goods_name ?>
                        <br/>商品数量&emsp;&emsp;&nbsp;:<input type="number" disabled name="goods_amount[]" min="1" value="1" class="box-input2 number<?= $k ?>"/>
                        <br/>协议价格人民币:<?= $v->price_agent_cny ?>
                        <br/>协议价格比索:<?= $v->price_agent_peso ?>
            ...
            <div class="box1">
                ...
                &nbsp;<input type="button" name="Submit" value="取消" class="btn btn-sm btn-success"
